...
export default function UserRecordPage() {
  ...
  const records = [
    {
      id: 1,
      title: "전문가 특강",
      subtitle: "컴퓨터소프트웨어공학과 OO 특강",
      date: "2024.11.05 14:27",
    },
    {
      id: 2,
      title: "전문가 특강",
  ...
  return (
    <main className="w-full min-h-screen flex flex-col p-6 pt-[44px]">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        {records.map((record) => (
          <div
            ...
            <div>
              <div className="text-lg font-semibold text-[#235698] mb-2">
                {record.title}
              </div>
